...
describe("JSONParser", () => {
  describe("parse()", () => {
    ...
    test("parses an object with single quoted keys", () => {
      const input = `{'name': "John", 'city': "New York"}`;
      const expectedOutput = { name: "John", city: "New York" };
    ...
    test("parses an object with non quoted keys", () => {
    ...
    test("parses an object with non quoted keys with spaces before colon", () => {
      const input = `{ name : "John"}`;
      const expectedOutput = { name: "John"};
    ...
    test("parses an object with non quoted keys with internal spaces", () => {
      const input = `{ first name : "John"}`;
      const expectedOutput = { "first name": "John"};
    ...
    test("it does not throw an error for unquoted keys", () => {
      const input = '{name: "John"}';
    ...
    test("it does not throw an error for non-string keys", () => {
      const input = '{42: "John"}';
      const parser = new JSONParser(input);

      const expected = { 42: "John" };
